...
class practica3a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Phyton", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica3a")
...
def main(top_block_cls=practica3a, options=None):
